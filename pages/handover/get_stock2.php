...
$sql = "SELECT stock_detail_amount FROM tb_stock_detail WHERE ref_plant_id ='$plant_id' AND stock_detail_status ='ปกติ'";
...
if (mysqli_num_rows($re) > 0) {
    ...
    while ($row = mysqli_fetch_array($re)) {
        ...
        $output.= ' <input type="textbox" class="form-control stock_amount" id="stock_amount" name="stock_amount" value ="'.$stock_amount.'" readonly>';
