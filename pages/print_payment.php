...
$pdf->Cell(62, 2, iconv('UTF-8', 'TIS-620', 'เลขที่ใบเสร็จ : ' . $sale_list), 0, 0);
...
tb_payment.payment_recieve as payment_recieve
...
WHERE tb_payment_detail.ref_payment_id='$sale_list' AND tb_grade.grade_id = tb_payment_detail.ref_grade_id 
...
$pdf->Ln();
$recieve = str_replace(",", "", $recieve);

$pdf->Cell(51, 5, iconv('UTF-8', 'TIS-620', 'เงินสด/เงินทอน'), 0, 0);
$pdf->Cell(20, 5, iconv('UTF-8', 'TIS-620', number_format($recieve, 2)), 0, 0, "R");

$change = $recieve - $sumval;
