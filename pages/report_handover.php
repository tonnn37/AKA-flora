...
if ($select == 'day' && $st_date != "" && $en_date != '') {
    ...
    tb_grade.grade_name AS grade_name, tb_stock_handover_detail.handover_detail_amount AS handover_detail_amount, SUM(tb_order.order_price) AS SUM
    ...
    WHERE (tb_stock_handover.handover_status ='เสร็จสิ้น' AND tb_stock_handover.handover_date BETWEEN '$st_date' AND '$en_date')
    GROUP BY tb_stock_handover.handover_id,tb_stock_handover_detail.ref_grade_id
    ORDER BY tb_stock_handover.handover_id,tb_grade.grade_id ASC";
    ...
    INNER JOIN tb_stock_handover_detail ON tb_stock_handover_detail.ref_handover_id=tb_stock_handover.handover_id
    INNER JOIN tb_grade ON tb_grade.grade_id=tb_stock_handover_detail.ref_grade_id
    WHERE (tb_stock_handover.handover_status ='เสร็จสิ้น' AND MONTH(tb_stock_handover.handover_date)='$month' AND YEAR(tb_stock_handover.handover_date)='$my')
    GROUP BY tb_stock_handover.handover_id,tb_stock_handover_detail.ref_grade_id
    ORDER BY tb_stock_handover.handover_id,tb_grade.grade_id ASC";
    ...
    INNER JOIN tb_stock_handover_detail ON tb_stock_handover_detail.ref_handover_id=tb_stock_handover.handover_id
    INNER JOIN tb_grade ON tb_grade.grade_id=tb_stock_handover_detail.ref_grade_id
    WHERE  (tb_stock_handover.handover_status ='เสร็จสิ้น' AND YEAR(tb_stock_handover.handover_date)='$year')
    GROUP BY tb_stock_handover.handover_id,tb_stock_handover_detail.ref_grade_id
    ORDER BY tb_stock_handover.handover_id,tb_grade.grade_id ASC";
    ...
    INNER JOIN tb_stock_handover_detail ON tb_stock_handover_detail.ref_handover_id=tb_stock_handover.handover_id
    INNER JOIN tb_grade ON tb_grade.grade_id=tb_stock_handover_detail.ref_grade_id
    WHERE (tb_stock_handover.handover_status ='เสร็จสิ้น' AND tb_customer.customer_id='$customer')
    GROUP BY tb_stock_handover.handover_id,tb_stock_handover_detail.ref_grade_id
    ORDER BY tb_stock_handover.handover_id,tb_grade.grade_id ASC";
    ...
    INNER JOIN tb_stock_handover_detail ON tb_stock_handover_detail.ref_handover_id=tb_stock_handover.handover_id
    INNER JOIN tb_grade ON tb_grade.grade_id=tb_stock_handover_detail.ref_grade_id
    WHERE (tb_stock_handover.handover_status ='เสร็จสิ้น' AND tb_order.order_name ='$handover)
    GROUP BY tb_stock_handover.handover_id,tb_stock_handover_detail.ref_grade_id
    ORDER BY tb_stock_handover.handover_id,tb_grade.grade_id ASC";
...
if (mysqli_num_rows($result) > 0) {
 ...
 ';
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $date = date("d-m-Y",strtotime($row['handover_date']));
        if ($IDS == $id) {
            $ida = " ";
            $i2 = " ";
            $fname = " ";
   ...
   <tr>
            <td  class="id">' . $i . '</td>
            <td  class="handover_id">' .  $ida . '</td>
            <td  class="customer_firstname">' .  $fname ." "." ". $lname.  '</td>
            <td  class="plant_name">' . $pname . '</td>
            <td  class="grade_name">' . $row["grade_name"] . '</td>
            <td  class="date">' .  $date. '</td>
            <td  align = right class="handover_detail_amount">' . number_format($row["handover_detail_amount"]). '</td>
