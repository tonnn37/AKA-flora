...
WHERE tb_order_detail.ref_order_id='$id' AND tb_order_detail.order_detail_status = 'ปกติ' AND tb_order_detail.order_detail_planting_status ='กำลังทำการปลูก' AND tb_order.order_status = 'ปกติ'
