...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $subdata[] = /*'<a href="#    ' . $row['planting_detail_id'] . '" data-toggle="modal" >
        <button type="button" class="btn btn-warning btn-sm" id="edit_detail" data="' . $row['planting_detail_id'] . '"
            data-toggle="tooltip"  title="แก้ไขข้อมูล"" >
            <i class="fas fa-edit" style="color:white"></i></button>
    </a>'.*/ '
        <a href="#view_planting_list" data-toggle="modal">
        <button type="button" class="btn btn-info btn-sm"  id="btn_view_planting_list" data-id ="' . $row['planting_detail_id'] . '"
